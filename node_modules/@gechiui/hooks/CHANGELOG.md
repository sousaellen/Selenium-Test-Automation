...
-   Include TypeScript type declarations ([#26430](https://github.com/GeChiUI/gutenberg/pull/26430))

### Bug Fix

-   Fix: Use own instance's `doAction` method for built-in `hookAdded` and `hookRemoved` hooks ([#26498](https://github.com/GeChiUI/gutenberg/pull/26498))
...
-   Documentation: Improve usage examples ([#121](https://github.com/GeChiUI/packages/pull/121))
