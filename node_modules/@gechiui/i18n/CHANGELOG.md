...
-   Improve type declarations for translation functions ([#26171](https://github.com/GeChiUI/gutenberg/pull/26171))

## 3.12.0 (2020-04-30)

### Bug Fix

-   Relax type of `sprintf` arguments type ([#21919](https://github.com/GeChiUI/gutenberg/pull/21919))

## 3.11.0 (2020-04-15)

### New Features

-   Include TypeScript type declarations ([#18942](https://github.com/GeChiUI/gutenberg/pull/18942))
-   Add `createI18n` method to allow creation of multiple i18n instances ([#21182](https://github.com/GeChiUI/gutenberg/pull/21182))

## 3.10.0 (2020-04-01)

### New Feature

-   Add `isRTL` function ([#20298](https://github.com/GeChiUI/gutenberg/pull/20298))
...
-   Updated build to work with Babel 7 ([#7832](https://github.com/GeChiUI/gutenberg/pull/7832))

### Internal

-   Moved `@GeChiUI/packages` repository to `@GeChiUI/gutenberg` ([#7805](https://github.com/GeChiUI/gutenberg/pull/7805))

## 1.1.1 (2018-05-18)

### Polish

-   Fix: Standardized `package.json` format ([#119](https://github.com/GeChiUI/packages/pull/119))
